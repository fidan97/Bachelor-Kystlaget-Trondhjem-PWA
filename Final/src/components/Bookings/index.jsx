...
const Bookings = ({ currentUserBookings }) => {
  ...
  //   {
  //     bookingID: 1,
  //     startTime: "2022-04-26T12:00:00",
  //     endTime: "2022-04-26T16:00:00",
  ...
  const settings = {
    dots: false,
    infinite: bookings.value?.length > 1 ? true : false,
    speed: 500,
    slidesToShow: 2,
    slidesToScroll: 1,
    autoplay: false,
    ...
    <div className="flex flex-col gap-4 mb-20 sm:mb-12 relative">
      ...
      <div className="flex items-center gap-1 sm:gap-4">
        {toggleList.map((toggle, index) => (
          <Button
            key={index}
            type="button"
            className={`!bg-transparent  capitalize !shadow-none  !p-1 border-current !rounded-none sm:!text-lg ${
      ...
      <div className="flex justify-end items-center gap-2">
        <Button
          ...
          onClick={handlePrev}
          variant="icon"
          className="bg-primary-600 w-8 active:bg-primary-800
          hover:bg-primary-800  text-secondary-400 !p-1 disabled:bg-primary-400"
        >
        ...
        <Button
          ...
          variant="icon"
          className="bg-primary-600 w-8 active:bg-primary-800
          hover:bg-primary-800  text-secondary-400 !p-1"
        >
      ...
      <Popup
        ...
        subtitle={"Your booking have been updated successfully "}
      />
      <Popup
        icon={<HiOutlineCheck size={100} />}
        iconClassName={"bg-secondary-600 text-white"}
        ...
        subtitle={"Your booking have been deleted successfully "}
      />
      ...
      <Popup
        ...
        subtitle={`This will permanent delete booking ID. ${selectedBookingId.value}`}
      />
    </div>
  );
};
